  ...
  return (
    <div className="flex justify-center items-center py-20">
      <div className="animate-pulse text-center">
        <div className="h-8 w-48 bg-gray-200 mb-4 mx-auto rounded"></div>
        <div className="h-4 w-64 bg-gray-200 mb-2 mx-auto rounded"></div>
        <div className="h-4 w-56 bg-gray-200 mx-auto rounded"></div>
      </div>
    </div>
  );
}
